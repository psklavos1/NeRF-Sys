...
# System Implementation of Adaptive City NeRF
...
1. Make sure CUDA is compatible:
```bash
...
2. Install using the official [NVLabs](https://github.com/NVlabs/tiny-cuda-nn?utm_source) instructions:
```bash
...
NeRF operation logging their results at `logs/<job_id>`:
